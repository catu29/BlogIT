                    ...
                    <form class="col-md-12" method="POST" action="${updateAction}" enctype="multipart/form-data">
                        ...
                        <div class="custom-file-container" data-upload-id="myUniqueUploadId">
                            ...
                            <label class="custom-file-container__custom-file" >
                                <input data-userid="${postBean.userId}" data-imgurl="${postBean.image}" id="image" name="image" type="file" class="custom-file-container__custom-file__custom-file-input" accept="*" aria-label="Choose File" required>
